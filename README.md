...
| **MCP Server** | Standard Model Context Protocol — 32 tools for AI agents |
...
| **MCP Server** | 标准 MCP 协议，31 个工具供 AI 调用 |
...
| AI 工具集成 | 31 个 MCP 工具 | 无 | 无 | Copilot |

...
export function createRequest(
  ...
  const id = randomUUID()
  if (action === "connect" || action === "connectJson" || action === "exec" || action === "disconnect" || action === "transfer" || action === "bgExec" || action === "portForward" || action === "schedule" || action === "queueStatus" || action === "waitTask" || action === "dequeueTask" || action === "cancelTask" || action === "getTaskOutput" || action === "getTaskStatus" || action === "cleanupOutputs" || action === "abortActiveTasks" || action === "setCwd" || action === "getCwd") {
